...
class _$_Success implements _Success {
  const _$_Success({required final List<Feed> feed}) : _feed = feed;
  ...
  @override
  String toString() {
    return 'HomeState.success(feed: $feed)';
  }
...
abstract class _Success implements HomeState {
  const factory _Success({required final List<Feed> feed}) = _$_Success;
...
abstract class _$$_ErrorCopyWith<$Res> {
  ...
  @useResult
  $Res call({FeedError error});

  $FeedErrorCopyWith<$Res> get error;
}
...
class __$$_ErrorCopyWithImpl<$Res>
  ...
  @pragma('vm:prefer-inline')
  $FeedErrorCopyWith<$Res> get error {
    return $FeedErrorCopyWith<$Res>(_value.error, (value) {
...
abstract class _Error implements HomeState {
  const factory _Error({required final FeedError error}) = _$_Error;
