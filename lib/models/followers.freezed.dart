...
abstract class $FollowersCopyWith<$Res> {
  ...
  @useResult
  $Res call({int? id, String? username, String? image});
}
...
/// @nodoc
@JsonSerializable()
class _$_Followers extends _Followers {
  const _$_Followers(
  ...
  @override
  String toString() {
    return 'Followers(id: $id, username: $username, image: $image)';
  }
...
abstract class _Followers extends Followers {
  const factory _Followers(
      {required final int? id,
      required final String? username,
      required final String? image}) = _$_Followers;
  const _Followers._() : super._();
